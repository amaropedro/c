...
main()
{
	...
	do
	{
		...
		{
			printf("base maior que 35, digite novamente\n");
		}
	}while((b1>25)||(b1<2)||BL);
	
	do
	{
		printf("digite a base na qual deseja transformar: \n"); scanf("%d", &b2); setbuf(stdin,NULL);
