...
main()
{
	...
	int cont=0, aux=0, auxp=0,i, j, b1=2, b2=2, l, BL, ml=0, v=-1, p=0, MC;
	double base10=0, afterp=0, n;
	char  mc=NULL, c, *N=NULL, *V=NULL, *BN=NULL, *BV=NULL;
	...
	do
	{
		...
		{
			printf("base maior que 25, digite novamente\n");
		}
		else if(MC>=b1)
		{
			printf("a base nao vai ate o maior numero digitado, tente novamente\n");
		}
	}while((b1>25)||(b1<2)||BL||MC>=b1);
